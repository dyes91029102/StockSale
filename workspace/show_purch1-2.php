<?php
    ...
    $sql = "select PurOder_id,a.Emp_name as c,Order_Emp_id,b.Emp_name as d,check_Emp_id,PurOder_date,
            ...
            left join Emp b on check_Emp_id=b.Emp_id WHERE PurOder_date IS NOT NULL AND PurOder_id not in(select PurOder_id from Reform)";
    $st = $db->prepare($sql); 
    $st->execute();
    ...
    $Smarty->display('smarty/templates/show_purch1-2.tpl');
?>