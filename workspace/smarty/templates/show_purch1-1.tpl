    ...
    <div id="wrapper">
        ...
        <div id="sidebar-wrapper">
            <ul class="sidebar-nav">
                ...
                <ul>
                    <li>
                        <a href="https://db-finalreport-john777.c9users.io/show_return4-1.php"><h4><font color=white>退貨單列表</font></h4></a>
                    </li>
                    <li>
        ...
        <div id="page-content-wrapper">
            ...
            <div>
                <ul class="nav nav-tabs">
                  ...
                  <li role="presentation" ><a href="https://db-finalreport-john777.c9users.io/show_purch1-2.php">已收貨</a></li>
                  <li role="presentation" ><a href="https://db-finalreport-john777.c9users.io/show_purch1-3.php">所有訂單</a></li>
                </ul>    
            </div>
            ...
            <br>
                <table>
                    ...
                    <tr>
                        <td>
                            <a href="show_select3-3.php?func2={$i['PurOder_id']}"><span class="glyphicon glyphicon-search" aria-hidden="true"></span></a>
                        </td>
                            {foreach from=$i item=j}
                                <td>{$j}</td>
                            {/foreach}
                            <td>
                                <a href="https://db-finalreport-john777.c9users.io/show_purch_confirm.php?func3={$i['PurOder_id']}">
                                    <button class="btn btn-default">確認</button>
                                </a>
                            </td>
                            <td>
                                <button class="btn btn-default">
                                    <a href="https://db-finalreport-john777.c9users.io/show_del_pur_btn.php?func3={$i['PurOder_id']}">
