    ...
    <body background="../css/img/bg001.jpg" width=1000>
        <div style="text-align:auto;" align="center">
	        <div style="margin:0 auto;">
	            <br>
    	            <form action="do_return_confirm.php" method="post">
                            ...
                            <tr>
                                ...
                                <td>
                                    <p>
                                        ...
                                        <input type="date" id="bookdate" value={$today} placeholder="2014-09-18" name="date">
                                    </p>
                                </td>
                                <td>
                                    <!--<a href="https://db-finalreport-john777.c9users.io/do_return_confirm.php?func4={$func3}"><button class="btn btn-default">確認</button></a>-->
