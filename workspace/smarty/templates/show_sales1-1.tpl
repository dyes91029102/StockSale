    ...
    <div id="wrapper">
        ...
        <div id="sidebar-wrapper">
            <ul class="sidebar-nav">
                ...
                <ul>
                    <li>
                        <a class="active" href="#"><h4><font color=white>銷貨訂單列表</font></h4></a>
                    </li>
                    <li>
                        <a href="index.php?func=show_sales2-1"><h4><font color=white>新增銷貨訂單</font></h4></a>
                    </li>
                    <li>
                        <a href="index.php?func=show_sales3-1"><h4><font color=white>查詢銷貨訂單</font></h4></a>
                    </li>
                </ul>
            </ul>
        </div>
            ...
            <br>
                <table>
                    ...
                    {foreach from=$field_content_array item=i}
                        <tr>
                            <td>
                                <a href="index.php?func=show_sales3-3&func2={$i['Order_id']}"><span class="glyphicon glyphicon-search" aria-hidden="true"></span></a>
                            </td>
                            ...
                            <td>
                                <button class="btn btn-default">
                                    <a href="index.php?func=show_del_order&func3={$i['Order_id']}">
            ...
            <nav>
                <center>
                    <ul class="pagination">
                        ...
                        {else}
                            <li><a href="?func=show_sales1-1&page={$current_page-1}"><span aria-hidden="true">&laquo;</span><span class="sr-only">Previous</span></a></li>
                        {/if}
                        <!--列出所有頁數-->
                        {for $foo=1 to $total_page}
                            <li><a href="?func=show_sales1-1&page={$foo}">{$foo}</a></li>
                        {/for}
                        <!--在最後一頁 往後一頁無效-->
                        {if $current_page eq $total_page}
                            <li><span aria-hidden="true">&raquo;</span></li>
                        {else}
                            <li><a href="?func=show_sales1-1&page={$current_page+1}"><span aria-hidden="true">&raquo;</span><span class="sr-only">Next</span></a></li>
                        {/if}
                    </ul>
                </center>
            </nav>
