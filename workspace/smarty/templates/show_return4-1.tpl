    ...
    <div id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <ul class="nav nav-tabs">
              <li role="presentation" class="active"><a href="#">待退貨</a></li>
              <li role="presentation" ><a href="https://db-finalreport-john777.c9users.io/show_return4-2.php">已退貨</a></li>
              <li role="presentation" ><a href="https://db-finalreport-john777.c9users.io/show_return4-3.php">所有退貨單</a></li>
            </ul>    
            </div>
            ...
            <br>
                <table>
                    ...
                    {foreach from=$field_content_array item=i}
                        <tr>
                            <td>
                                <a href="https://db-finalreport-john777.c9users.io/show_return5-3.php?func2={$i['Reform_id']}">
                            ...
                            <td>待退貨</td>
                            <td>
                              <a href="https://db-finalreport-john777.c9users.io/show_return_confirm.php?func3={$i['PurOder_id']}">    
                                <button class="btn btn-default">確認</button>
                              </a>
                            </td>
                            <td>
                              <a href="https://db-finalreport-john777.c9users.io/show_delete.php?func3={$i['Reform_id']}">   
