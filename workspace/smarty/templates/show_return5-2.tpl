...
<body>
    <div id="wrapper">
        ...
        <div id="sidebar-wrapper">
            <ul class="sidebar-nav">
                ...
                <ul>
                    ...
                    <li>
                        <a class="active" href="#"><h4><font color=white>查詢退貨單</font></h4></a>
                    </li>
                </ul>
            </ul>
        </div>
        ...
        <div id="page-content-wrapper">
            ...
            <br>
              <form method="POST" action="do_reform.php">
                <table>
                    <tr bgcolor=#6495ed>
                        <td><b>退貨單明細</b></td>
                        <td><b>退貨單編號</b></td>
                    ...
                    <tr>
                        <td>
                            <a href="show_return5-3.php?func2={$i['Reform_id']}"><span class="glyphicon glyphicon-search" aria-hidden="true"></span></a>
                        </td>
