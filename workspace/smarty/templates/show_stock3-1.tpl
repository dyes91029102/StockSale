...
<body>
    <div id="wrapper">
            ...
            <ul class="sidebar-nav">
               ...
               <li>
                ...
                <ul>
                    ...
                    <li>
                        <a class="active" href="index.php?func=show_stock3-1"><h4><font color=white>查詢盤點單</font></h4></a>
                    </li>
                </ul>
            </ul>
        </div>
        ...
        <div id="page-content-wrapper">
            ...
            <br>
                <form action="index.php?func=show_stock3-2" method="post">
                    <table>
                    <tr bgcolor=#6495ed>
                        <td><b>請選擇搜尋條件</b></td>
                        <td><b>請填入收尋值</b></td>
                        ...
                        <tr>
                            <td>
                                    <select name="under">
                                         <option value="a">盤點人編號</option>
                                         <option value="b">盤點單編號</option>
                                    </select>
                            </td>
                            <td>
