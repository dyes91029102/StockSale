...
<body>
    <div id="wrapper">
        ...
        <div id="sidebar-wrapper">
            <ul class="sidebar-nav">
                ...
                <ul>
                    ...
                    <li>
                        <a class="active" href="#"><h4><font color=white>新增銷貨訂單</font></h4></a>
                    </li>
                    <li>
        ...
        <div id="page-content-wrapper">
            ...
            <br>
            <form action="index.php?func=do_sales_insert" method="POST">
                <div>
                    <font face="微軟正黑體" size='6'>
                        接單人員:&nbsp;&nbsp;
                ...
                <br>
                    <table>
                        ...
                        {foreach from=$field_content item=i}
                            <tr>
