    ...
    <div id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <ul class="nav nav-tabs">
              <li role="presentation" ><a href="https://db-finalreport-john777.c9users.io/show_purch1-1.php">未收貨</a></li>
              <li role="presentation" class="active"><a href="">已收貨</a></li>
                ...
                <table>
                    ...
                    {foreach from=$field_content_array item=i}
                        <tr>
                            ...
                            {/foreach}
                            <td>
                              <a href="https://db-finalreport-john777.c9users.io/show_return_btn.php?func3={$i['PurOder_id']}">    
